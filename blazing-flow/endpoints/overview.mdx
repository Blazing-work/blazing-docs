...
label: Overview
description: Turn workflows into production REST APIs with HTTP/WebSocket support
position: 1
---

# Blazing Flow Endpoints

**Turn your Blazing Flow workflows into production-ready REST APIs in a few lines of code.**

Blazing Flow Endpoints wraps your workflows with a FastAPI layer and provides:
...
- 🌊 Streaming and webhook response modes
...
```
┌─────────────────┐         ┌──────────────────┐         ┌─────────────────┐
│  External       │  HTTP   │  FastAPI Layer   │  HTTP   │  Blazing Flow   │
