...
title: Examples
label: Examples
description: Real-world examples of Blazing Flow Endpoints
position: 7
---
...
@app.endpoint(path="/secure/data", auth=verify_jwt)
@app.workflow
...
@app.endpoint(path="/admin/stats", auth=verify_api_key)
@app.workflow
