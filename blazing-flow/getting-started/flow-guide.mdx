...
async def main():
    ...
    # Execute workflow - three equivalent ways:
...
Workflows are the entry points to your pipelines. They orchestrate the flow of data through multiple stations.
...
Services encapsulate your business logic and can be shared across stations.
