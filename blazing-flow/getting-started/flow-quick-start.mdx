...
See the [Synchronous API guide](/docs/blazing-flow/getting-started/flow-guide#synchronous-api) for more details.

## Next Steps

Now that you have a basic pipeline running, explore more advanced features:

- **[Core Examples](/docs/blazing-flow/core-examples)** - See more workflow patterns
