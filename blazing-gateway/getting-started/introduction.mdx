---
title: Blazing Core Gateway Introduction
label: Blazing Core Gateway
description: Global edge gateway with VoIP capabilities and intelligent traffic routing
position: 0
---

Blazing Core Gateway is a global edge gateway that provides VoIP capabilities, intelligent traffic routing, and low-latency connectivity for real-time communication workloads within Blazing Core.

<Alert type="warning">
  <div className="flex flex-col gap-2">
    <div className="font-semibold">Coming Soon</div>
    <div>
      Blazing Core Gateway is currently in development. Get in touch for priority access and early-bird pricing.
    </div>
  </div>
</Alert>
...
Blazing Core Gateway provides a global edge network for:
...
Blazing Core Gateway runs at the edge of Blazing Core's global network:
...
Blazing Core Gateway seamlessly integrates with Blazing Core:
...
Blazing Core Gateway pricing will be based on usage:
...
<Alert type="info">
  <div className="flex flex-col gap-2">
    ...
    <div>
      Blazing Core Gateway is coming soon. Contact us to get priority access and early-bird pricing.
    </div>
  </div>
</Alert>
...
1. **Request Access**: Contact us for Blazing Core Gateway early access
...
Need help with Blazing Core Gateway?
...
- **Contact Us**: Get priority access to Blazing Core Gateway
