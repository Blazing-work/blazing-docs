...
- [Get started with Blazing Gateway](/docs/blazing-core/getting-started/quick-start)
- [Review configuration options](/docs/blazing-gateway/configuration/configuration-reference)
