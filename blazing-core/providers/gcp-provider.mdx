...
Blazing Core on GCP supports spot instance node pools for cost optimization.
...
- **Secure Workload Identity**: Service account binding
- **Binary Authorization**: Image signing and verification

### Integrated GCP Services

Blazing Core on GCP integrates with:
