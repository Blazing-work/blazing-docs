...
description: "Blazing Core Compose uses a hierarchical organizational model to manage infrastructure at scale:. Part of the Blazing Core multi-cloud infrastructure"
position: 1
---
