...
label: Blazing Core
description: "Blazing Core is our multi-cloud, policy-driven orchestration service that enables you to describe compute workloads once and deploy them transparently"
position: 0
---
...
Ready to deploy your first workload? Check out the [Quick Start](/docs/quick-start) guide.
