...
label: Quick Start
description: "Provider Selection: Primary: GCP (cost-optimized) Fallback: [Akash, DFC]. Part of the Blazing Core multi-cloud infrastructure platform supporting GCP"
position: 1
---
...
- [Services](/docs/service-basics) - Understanding service configuration
- [Architecture](/docs/architecture) - Core platform architecture
- [Organizational Hierarchy](/docs/organizational-hierarchy) - Teams and projects

### Advanced Features

- [Autoscaling](/docs/autoscaling) - Scale based on metrics
- [Multi-Cloud](/docs/overview) - Deploy across clouds
- [Deployment Lifecycle](/docs/deployment-lifecycle) - Manage deployments

### Providers

- [GCP Provider](/docs/gcp-provider) - Deploy to Google Cloud
- [DFC Provider](/docs/dfc-provider) - Digital Frontier Cloud
- [Akash Provider](/docs/akash-provider) - Decentralized compute
